...
### 3. Yobai Mode 追加アニメーション

寝ている姿勢（低い位置）に対応するポーズ。

#### Crawl_Idle.anim (四つん這い待機)
```
姿勢: 四つん這い、または正座から身を乗り出す姿勢
高さ: 床から30-50cm（布団の高さ）
視線: 下から覗き込む、または上から覆いかぶさる
```

#### Crawl_Lean_100.anim (覆いかぶさり)
```
姿勢: 相手の顔の真上に覆いかぶさる（馬乗り直前）
顔: 相手の鼻先数センチ
手: 相手の枕元または肩に手を置く
```
